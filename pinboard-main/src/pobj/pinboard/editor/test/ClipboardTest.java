...
public class ClipboardTest {
	...
	@Test
	public void testCopy2() throws FileNotFoundException {
		Clipboard c = Clipboard.getInstance();
	...
	@Test
	public void testCopy3() throws FileNotFoundException {
		Clipboard c = Clipboard.getInstance();
		c.copyToClipboard(Arrays.asList(clip));
		clip[0].move(10.,  20.);
		List<Clip> l = c.copyFromClipboard();
	...
	@Test
	public void testCopy4() throws FileNotFoundException {
		Clipboard c = Clipboard.getInstance();
		c.copyToClipboard(Arrays.asList(clip));
