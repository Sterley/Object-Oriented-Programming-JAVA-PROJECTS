...
public class ClipboardListenerTest {
	...
	@Test
	public void testCopyClear() throws FileNotFoundException {
		Clipboard c = Clipboard.getInstance();
		EventCounter e = new EventCounter();
		c.addListener(e);
		c.copyToClipboard(Arrays.asList(clip));
	...
	@Test
	public void testCopyMulti() throws FileNotFoundException {
		Clipboard c = Clipboard.getInstance();
	...
	@Test
	public void testRemoveMulti() throws FileNotFoundException {
		Clipboard c = Clipboard.getInstance();
		EventCounter e1 = new EventCounter();
		EventCounter e2 = new EventCounter();
		c.addListener(e1);
